...
model15 = graphlab.linear_regression.create(poly15_set_1_data, target = 'price', features = my_features, 
                                            validation_set = None)
...
plt.plot(poly15_set_1_data['power_1'],poly15_set_1_data['price'],'.',
        poly15_set_1_data['power_1'], model15.predict(poly15_set_1_data),'-')
...
model15 = graphlab.linear_regression.create(poly15_set_2_data, target = 'price', features = my_features, 
                                            validation_set = None)
...
plt.plot(poly15_set_2_data['power_1'],poly15_set_2_data['price'],'.',
        poly15_set_2_data['power_1'], model15.predict(poly15_set_2_data),'-')
...
model15 = graphlab.linear_regression.create(poly15_set_3_data, target = 'price', features = my_features, 
                                            validation_set = None)
...
plt.plot(poly15_set_3_data['power_1'],poly15_set_3_data['price'],'.',
        poly15_set_3_data['power_1'], model15.predict(poly15_set_3_data),'-')
...
model15 = graphlab.linear_regression.create(poly15_set_4_data, target = 'price', features = my_features, 
                                            validation_set = None)
...
plt.plot(poly15_set_4_data['power_1'],poly15_set_4_data['price'],'.',
        poly15_set_4_data['power_1'], model15.predict(poly15_set_4_data),'-')
...
for degree in range(1, 16):
    poly_degree_data = polynomial_sframe(training['sqft_living'], degree)
    my_features = poly_degree_data.column_names() # get the name of the features
    poly_degree_data['price'] = training['price'] # add price to the data since it's the target
    model_degree = graphlab.linear_regression.create(poly_degree_data, target = 'price', features = my_features, 
                                            validation_set = None, verbose=False)
    
    poly_val_data = polynomial_sframe(validation['sqft_living'], degree)
    actual = validation['price']
    predictions = model_degree.predict(poly_val_data)
    
    RSS = ((actual - predictions) ** 2).sum()
    
    print("RSS for %d is %f" % (degree, RSS))
...
predictions = model_degree.predict(poly_test_data)
RSS = ((actual - predictions) ** 2).sum()
print(RSS)
