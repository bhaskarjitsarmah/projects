...
predict_output(test_simple_feature_matrix, regression_gradient_descent(simple_feature_matrix, output, initial_weights, 
                                                                       step_size, tolerance))
...
predict_output(test_simple_feature_matrix, regression_gradient_descent(feature_matrix, output, initial_weights, 
                                                                       step_size, tolerance))
